 ...
 * @author GA_IA
 */
public class GoTo4 extends CollidableEntity implements Copyable{
        private final ChapterManager manager;

    public GoTo4(Scene s, ChapterManager manager) {
        super(s);
    ...
    public <T extends Entity> T copyOf() {
        return (T) new GoTo4(getScene(), manager);
    }
}
