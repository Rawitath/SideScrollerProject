...
import Main.ChapterThree.Entities.GoTo2Secret;
import Main.ChapterThree.Entities.GoTo2Well;
...
//        bosswall = new BossWall(this);
        ...
        MapBuilder.addVariable("Rope", new GoTo2Well(this, manager));
        MapBuilder.addVariable("GoTo2", new GoTo2Secret(this, manager));
        ...
        MapBuilder.setVariableClone("GoTo2", true);
